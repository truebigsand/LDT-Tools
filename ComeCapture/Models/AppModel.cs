...
namespace ComeCapture
{
    public class AppModel : EntityBase
    {
        ...
        private double _MaskLeftWidth = Cut.ScreenWidth;
        ...
        {
            sb.Clear();
            sb.Append((int)(Cut.Current.MainImage.Width * Cut.ScreenScale));
            sb.Append(" × ");
            sb.Append((int)(Cut.Current.MainImage.Height * Cut.ScreenScale));
