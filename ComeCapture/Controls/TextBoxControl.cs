...
namespace ComeCapture.Controls
{
    ...
    public class TextBoxControl : Control
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            _TextBox.MaxWidth = Cut.Current.MainImage.Width - Cut.Current.MainImage.point.X - 3;
            _TextBox.MaxHeight = Cut.Current.MainImage.Height - Cut.Current.MainImage.point.Y - 3;
        }
        ...
        protected void OnMyFocusValueChanged()
        {
            if (!MyFocus)
            {
                ...
                {
                    Cut.RemoveControl(this);
                }
                else
                {
                    Cut.Current.MainImage.ResetLimit(Canvas.GetLeft(this), Canvas.GetTop(this), (Canvas.GetLeft(this) + ActualWidth), (Canvas.GetTop(this) + ActualHeight));
                    Cut.Register(this);
                }
                Cut.Current.MainImage._Text = null;
            }
        }
        #endregion
    }
