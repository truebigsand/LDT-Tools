...
namespace ComeCapture.Controls
{
    public class ImageEditBar : Control
    {
        ...
        {
            CanvasLeft = AppModel.Current.MaskRightWidth > Cut.ScreenWidth - Width ? 0 : Cut.ScreenWidth - AppModel.Current.MaskRightWidth - Width;
        }
        #endregion
        ...
        private void ResetCanvasTop()
        {
            ...
            CanvasTop = AppModel.Current.MaskBottomHeight >= need ? Cut.ScreenHeight - AppModel.Current.MaskBottomHeight + 5
